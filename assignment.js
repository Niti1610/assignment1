...
let rate=Number(prompt("Enter Rate of Interest 1 to 10%"));
let time=Number(prompt("Time Period 1-12"));
...
let edge=Number(prompt("Enter Edge you will get the area of cube"));
alert((6*edge*edge));
